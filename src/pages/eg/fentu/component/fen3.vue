      ...
      drawingPic() {
        ...
        function createElementDiv(dataInfo, m, nodes, links, centerNodes) {
          ...
          if (dataInfo.name) {
            ...
            h4.innerHTML = dataInfo.name + '<a href="http://kankan.fun/" style="color: blue">查看详细信息>></a>';
          ...
          let x = nodes[m].positionX > 500 ? (nodes[m].positionX - 260) : nodes[m].positionX + 10;
          let y = nodes[m].positionY > 500 ? (nodes[m].positionY - 120) : nodes[m].positionY;
