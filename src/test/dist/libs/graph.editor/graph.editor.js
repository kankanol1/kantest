  ...
  r.prototype = {
    ...
    createJSONPane: function () {
      ...
      var n = i("graph-editor__json__buttons", e),
        o = [{name: "更新", action: this.exportJSON.bind(this)}, {name: "提交", action: this.submitJSON.bind(this)}];
    ...
    initToolbox: function (e, n, i) {
      var o = [{label: "Node", image: "Q-node"}, {
          type: "Text",
          label: "Text",
          html: '<span style="background-color: #003; color:#FFF; padding: 3px 5px;">文本</span>',
          styles: {"label.background.color": "#003", "label.color": "#FFF", "label.padding": new t.Insets(3, 5)}
