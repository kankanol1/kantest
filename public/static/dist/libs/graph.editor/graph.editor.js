!function (t, e) {
  ...
  function d(t, e) {
    // var n = new u, o = {version: "1.8 alpha", refs: {}}, s = [], a = {};
    var n = new u, o = {refs: {}}, s = [], a = {};
    if (t.currentSubNetwork) {
      var r = n.elementToJSON(t.currentSubNetwork);
      r && (o.currentSubNetwork = {_ref: r._refId = t.currentSubNetwork.id})
    }
  ...
  if (!t.Graph.prototype.parseJSON) {
    n.prototype = {
      _refs: null, _index: 1, root: null, reset: function () {
        this._refs = {}, this._index = 1
      }, getREF: function (t) {
        return this._refs[t]
      }, clearRef: function () {
        for (var t in this._refs) {
          var e = this._refs[t], n = e._value;
        ...
        if (void 0 !== t._refId) return t._refed = !0, {_ref: t._refId};
        var e = this._index++;
        t._refId = e;
        var n = this._toJSON(t);
        return n._refId = e, n._value = t, this._refs[e] = n, n
      }, _toJSON: function (t) {
        if (t._classPath) return {_classPath: t._classPath};
        if (!t._className) return t;
        var e = {_className: t._className};
        ...
        if (t._className) {
          var e = o(t._className), n = new e;
          if (void 0 !== t._refId && (this._refs[t._refId] = n), n && t.json) if (t = t.json, n.parseJSON) n.parseJSON(t, this); else for (var i in t) n[i] = t[i];
          return n
        }
        return t
      }
    ...
    t.BaseUI.prototype.toJSON = function (t) {
      ...
      _refs: null, _refValues: null, _index: 1, root: null, reset: function () {
        ...
        if (e._className) {
          var n = o(e._className), i = new n;
          if (this.withGlobalRefs && void 0 !== e._refId && (this._refs[e._refId] = i), i && e.json) if (e = e.json, i.parseJSON) i.parseJSON(e, this); else for (var s in e) i[s] = e[s];
          return i
        }
        if (t.isArray(e)) {
          var a = [];
      ...
      try {
        var n = new u({withGlobalRefs: !1}).toJSON(t);
        return e ? JSON.stringify(n) : n
      } catch (i) {
      }
    }, t.parseJSON = function (e) {
      try {
        return t.isString(e) && (e = JSON.parse(e)), new u({withGlobalRefs: !1}).parseJSON(e)
      } catch (n) {
      }
    }
  }
  ...
  function n(e, n) {
    ...
    for (var o = 0, s = i.length; s > o; o++) {
      var a = i[o], r = this._createDiv(this.parent);
  ...
  function i() {
    ...
    var a = function (e) {
      var n = this.graph;
      if (n) {
        var o = i.value, s = this.imageInfo.scale,
        ...
        var l = window.open(), h = l.document;
        h.title = n.name || "";
  ...
  n.prototype = {
    ...
    canvas: null, html: null, _getChild: function (t) {
      ...
      var o, s = this._getChild(".graph-export-panel__export_bounds"),
        a = this._getChild(".graph-export-panel__export_size"), r = function () {
          ...
          var i = o.x * n, s = o.y * n, a = o.width * n, r = o.height * n;
      ...
      this.updateOutputSize = function () {
        var t = this._getChild(".graph-export-panel__export_scale"), e = t.value,
          n = o.width / this.imageInfo.scale * e | 0, i = o.height / this.imageInfo.scale * e | 0, s = n + " X " + i;
  ...
  function a(n, i) {
    ...
    if ("input" == n.type) {
      ...
      var s = o.getElementsByTagName("input")[0], a = o.getElementsByTagName("button")[0];
    ...
    if (n.type) {
      var c = document.createElement("label"), a = document.createElement("input");
  ...
  function e(e, n, i) {
    var o = document.documentElement,
      s = new t.Rect(window.pageXOffset, window.pageYOffset, o.clientWidth - 2, o.clientHeight - 2), a = e.offsetWidth,
      r = e.offsetHeight;
  ...
  function o(e, n) {
    var o = n.popupmenu, s = i(e), a = s.x, r = s.y, l = o.getMenuItems(n, n.getElement(e), e);
  ...
  s.Separator = "divider", s.prototype = {
    dom: null, _invalidateFlag: !0, add: function (t) {
      ...
      var a = e.className;
      a && (n.className = a);
      var r = e.action, l = this, h = function (n) {
      ...
      var i = [];
      if (n) {
        var o = n instanceof t.ShapeNode, s = (n instanceof t.Group, !o && n instanceof t.Node, n instanceof t.Edge);
        if (i.push({
          ...
          i.push({
            text: a ? "实线样式" : "虚线样式", action: function () {
              n.setStyle(t.Styles.EDGE_LINE_DASH, a ? null : [5, 3])
            }
          }), i.push({
            text: "连线线宽", action: function () {
      ...
      i.push({
        ...
        text: "放大", action: function (t) {
          var n = e.globalToLocal(t);
          e.zoomIn(n.x, n.y, !0)
        }
      }), i.push({
        text: "缩小", action: function (t) {
          var n = e.globalToLocal(t);
          e.zoomOut(n.x, n.y, !0)
        }
      }), i.push({
        text: "1:1", action: function (t) {
          e.globalToLocal(t);
          e.scale = 1
        }
      }), i.push(t.PopupMenu.Separator);
      for (var r = e.interactionMode, l = [{text: "平移模式", value: t.Consts.INTERACTION_MODE_DEFAULT}, {
        text: "框选模式",
        value: t.Consts.INTERACTION_MODE_SELECTION
  ...
  function a(e, n) {
    n = e.name || n;
    var a = e.root, r = e.images, l = i("group"), d = i("group__title", l);
    d.onclick = f, i(null, d, "span", n), i("icon group-expand", d, "span");
    var c = i("group__items", l), p = document.createElement("div");
    if (p.style.clear = "both", l.appendChild(p), !r) return l;
    var _ = e.imageWidth || this.imageWidth, g = e.imageHeight || this.imageHeight;
    return u(r, function (e, n) {
      if ("_classPath" != n && "_className" != n) {
        ...
        if (r) {
          var d;
          t.isString(r) ? (d = r, !t.hasImage(r) && a && (r = a + r)) : d = e.imageName || e.name || n || "drawable-" + this._index++, t.hasImage(d) || t.registerImage(d, r), l = t.createCanvas(_, g, !0), t.drawImage(d, l, o(e.styles)), s(e) ? e = {image: d} : e.image = d, u = d
        } else {
          if (!e.html) return;
  ...
  d[t.Styles.SHAPE_FILL_COLOR] = t.toColor(3435973836),
    d[t.Styles.SELECTION_COLOR] = "#fff",
    d[t.Styles.SELECTION_SHADOW_BLUR] = 5,
    d[t.Styles.SELECTION_SHADOW_OFFSET_X] = 2,
    d[t.Styles.SELECTION_SHADOW_OFFSET_Y] = 2;
  var c = {
    fillColor: "#fff",
    lineWidth: 1,
    strokeStyle: "#2898E0",
    ...
    initToolbox: function (e, n, i) {
      var o = [
          ...
          },
          {
            type: "Text",
            label: "Text",
            html: '<span style="background-color: #000; color:#FFF; padding: 3px 5px;">文本</span>',
            styles: {"label.background.color": "#000", "label.color": "#fff", "label.padding": new t.Insets(3, 5)}
          },
          {
            type: "Group",
            label: "Group",
        ...
        s = [
          {name: "基本节点", images: o},
          {name: "注册图标", images: t.getAllImages()},
          /*          {name: "内置形状",
